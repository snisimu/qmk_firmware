...
[NUMB] = LAYOUT_gergoplex(
  ...
  RSFT(KC_1), RSFT(KC_2), RSFT(KC_3), RSFT(KC_4), RSFT(KC_5), /* */ RSFT(KC_6), RSFT(KC_7), RSFT(KC_8), RSFT(KC_9), RSFT(KC_0),
  RGUI_T(KC_ESCAPE), LT(FNUM, KC_SPC), RSFT_T(KC_TAB), // Left
  RALT_T(KC_BSPACE), LT(NUMB, KC_ENT), LCTL(KC_7) // Right
),

[CURS] = LAYOUT_gergoplex(
  RSFT(KC_LBRACKET), LSFT(KC_RBRACKET), KC_EQUAL, RSFT(KC_MINUS), RSFT(KC_BSLASH), /* */ KC_APPLICATION, KC_MS_LEFT, KC_MS_DOWN, KC_MS_UP, RGUI_T(KC_MS_RIGHT),
  LCTL_T(KC_SLASH), RSFT(KC_EQUAL), KC_MINUS, KC_MS_BTN1, KC_MS_BTN2, /* */ KC_DELETE, KC_LEFT, KC_DOWN, KC_UP, RCTL_T(KC_RGHT),
  KC_LBRACKET, KC_RBRACKET, KC_BSLASH, RSFT(KC_SLASH), KC_GRAVE, /* */ KC_TILDE, KC_HOME, KC_PGDOWN, KC_PGUP, RSFT_T(KC_END),
  RGUI_T(KC_ESCAPE), LT(CURS, KC_SPC), RSFT_T(KC_TAB), // Left
