...
const uint16_t PROGMEM dmy_combo[] = {KC_QUOT, KC_SCLN, KC_L, KC_Z, COMBO_END};
...
[BASE] = LAYOUT_gergoplex(
  ...
  RGUI_T(KC_NO), LT(CURSOR, RCTL(KC_7)), RSFT_T(KC_ESCAPE), // Left
  RALT_T(KC_ENT), LT(NUMSYM, KC_SPC), RCTL_T(KC_NO) // Right
),
...
[NUMSYM] = LAYOUT_gergoplex(
  ...
  KC_NO, KC_LSHIFT, KC_NO, // Left
  KC_NO, KC_NO, KC_NO // Right
),

[CURSOR] = LAYOUT_gergoplex(
  KC_LALT, KC_LGUI, KC_LCTRL, KC_TAB, KC_NO, /* */ KC_NO, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT,
  ...
  KC_ENT, RSFT_T(KC_SPC), KC_NO // Right
),
